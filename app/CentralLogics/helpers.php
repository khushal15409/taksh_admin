...
//        }
    ...
    public static function get_login_url($type){
        $data=DataSetting::whereIn('key',['store_employee_login_url','store_login_url','admin_employee_login_url','admin_login_url','logistics_login_url'
    ...
    public static function get_full_url($path,$data,$type,$placeholder = null){
        $place_holders = [
            ...
            'warehouse' => asset('public/assets/admin/img/160x160/img2.jpg'),
            'miniwarehouse' => asset('public/assets/admin/img/160x160/img2.jpg'),
        ];
