...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module', 'actch:admin_panel' ]], function () {
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
            Route::get('dashboard-list/{status}', 'OrderController@dashboard_list')->name('dashboard-list');
        ...
        Route::group(['prefix' => 'logistics', 'as' => 'logistics.'], function () {
            Route::get('warehouse', 'Logistics\WarehouseController@index')->name('warehouse.index');
            Route::get('warehouse/create', 'Logistics\WarehouseController@create')->name('warehouse.create');
            Route::post('warehouse', 'Logistics\WarehouseController@store')->name('warehouse.store');
            Route::get('warehouse/{id}/edit', 'Logistics\WarehouseController@edit')->name('warehouse.edit');
            Route::put('warehouse/{id}', 'Logistics\WarehouseController@update')->name('warehouse.update');
            Route::delete('warehouse/{id}', 'Logistics\WarehouseController@destroy')->name('warehouse.destroy');
            Route::post('warehouse/status', 'Logistics\WarehouseController@status')->name('warehouse.status');
            
            Route::get('miniwarehouse', 'Logistics\MiniwarehouseController@index')->name('miniwarehouse.index');
            Route::get('miniwarehouse/create', 'Logistics\MiniwarehouseController@create')->name('miniwarehouse.create');
            Route::post('miniwarehouse', 'Logistics\MiniwarehouseController@store')->name('miniwarehouse.store');
            Route::get('miniwarehouse/{id}/edit', 'Logistics\MiniwarehouseController@edit')->name('miniwarehouse.edit');
            Route::put('miniwarehouse/{id}', 'Logistics\MiniwarehouseController@update')->name('miniwarehouse.update');
            Route::delete('miniwarehouse/{id}', 'Logistics\MiniwarehouseController@destroy')->name('miniwarehouse.destroy');
            Route::post('miniwarehouse/status', 'Logistics\MiniwarehouseController@status')->name('miniwarehouse.status');
            
            Route::get('lm-center', 'Logistics\LmCenterController@index')->name('lm-center.index');
            Route::get('lm-center/create', 'Logistics\LmCenterController@create')->name('lm-center.create');
            Route::post('lm-center', 'Logistics\LmCenterController@store')->name('lm-center.store');
            Route::get('lm-center/{id}/edit', 'Logistics\LmCenterController@edit')->name('lm-center.edit');
            Route::put('lm-center/{id}', 'Logistics\LmCenterController@update')->name('lm-center.update');
            Route::delete('lm-center/{id}', 'Logistics\LmCenterController@destroy')->name('lm-center.destroy');
            Route::post('lm-center/status', 'Logistics\LmCenterController@status')->name('lm-center.status');
            Route::post('lm-center/verify-document', 'Logistics\LmCenterController@verifyDocument')->name('lm-center.verify-document');
            
            Route::get('fm-rt-center', 'Logistics\FmRtCenterController@index')->name('fm-rt-center.index');
            Route::get('fm-rt-center/create', 'Logistics\FmRtCenterController@create')->name('fm-rt-center.create');
            Route::post('fm-rt-center', 'Logistics\FmRtCenterController@store')->name('fm-rt-center.store');
            Route::get('fm-rt-center/{id}/edit', 'Logistics\FmRtCenterController@edit')->name('fm-rt-center.edit');
            Route::put('fm-rt-center/{id}', 'Logistics\FmRtCenterController@update')->name('fm-rt-center.update');
            Route::delete('fm-rt-center/{id}', 'Logistics\FmRtCenterController@destroy')->name('fm-rt-center.destroy');
            Route::post('fm-rt-center/status', 'Logistics\FmRtCenterController@status')->name('fm-rt-center.status');
            
            Route::get('pending-mapping', 'Logistics\PendingMappingController@index')->name('pending-mapping.index');
        });
    });
});
