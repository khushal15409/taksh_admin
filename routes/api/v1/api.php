...
// WebSocket functionality temporarily disabled - beyondcode/laravel-websockets not compatible with Laravel 12
// TODO: Replace with Laravel Reverb or alternative WebSocket solution
    ...
    Route::group(['middleware'=>['module-check']], function(){
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            ...
            Route::group(['prefix' => 'address'], function () {
                ...
                Route::post('validate-30-minute', 'CustomerController@validate_30_minute_address')->withoutMiddleware(['auth:api']);
            });
        ...
        Route::group(['prefix' => 'stores'], function () {
            ...
            Route::get('list', 'StoreController@get_stores');
            Route::get('thirty-minute-delivery', 'StoreController@get_thirty_minute_delivery_stores');
        });
...
// WebSocket route temporarily disabled - needs Laravel 12 compatible WebSocket solution
