...
<tr class="status-{{$order['order_status']}} class-all">
    ...
    <td>
        @if($order->customer)
            <a class="text-body text-capitalize" href="{{route('admin.users.customer.view',[$order['user_id']])}}@if(request('status') || request('tab'))?status={{request('status')}}&tab={{request('tab')}}@elseif(request('status'))?status={{request('status')}}@elseif(request('tab'))?tab={{request('tab')}}@endif">
