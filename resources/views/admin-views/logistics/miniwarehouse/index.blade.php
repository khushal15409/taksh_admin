                    ...
                    @foreach($miniwarehouses as $key=>$miniwarehouse)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{route('admin.logistics.miniwarehouse.status')}}" method="post" id="status-{{$miniwarehouse['id']}}">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$miniwarehouse['id']}}">
                                    <input type="hidden" name="status" value="{{$miniwarehouse->status?0:1}}">
                                </form>
                            </td>
                            <td>
